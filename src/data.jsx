...
export const CategoryList = [
  ...
  export const BlogList = [
  {
    ...
    totalComments: 89,
    totalLikes:2300,
    content: `Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio corrupti alias saepe aut inventore quis numquam ratione error fugit quos? Placeat perspiciatis rem commodi ea dolores hic esse qui nam repudiandae sunt, ex sapiente praesentium accusamus itaque repellendus officiis molestiae, ipsum nemo consequuntur eos cumque. Odio, aperiam natus nostrum fugit saepe amet? Explicabo repellendus iure praesentium dolorum ipsa veritatis eveniet et sit modi eius? Facere qui libero nihil. Fuga iure tempora nesciunt nemo minus dolor unde mollitia expedita aliquam ipsa aperiam, ab enim deleniti nihil quo natus laudantium vel rerum, architecto deserunt blanditiis. Quasi consectetur porro necessitatibus dolorum? Hic, eligendi? In the ever-evolving landscape of transportation, the emergence of electric cars has sparked a revolution. Exploring the world of electric cars unveils a myriad of innovations and possibilities that are reshaping the way we perceive mobility. Electric cars, also known as electric vehicles (EVs), are automobiles powered by one or more electric motors using energy stored in rechargeable batteries. This departure from traditional internal combustion engines marks a significant shift towards sustainability and environmental consciousness. As concerns about fossil fuel depletion and climate change intensify, electric cars have emerged as a promising solution to mitigate the impact of transportation on the planet.`,
  },
  {
    id: 2,
